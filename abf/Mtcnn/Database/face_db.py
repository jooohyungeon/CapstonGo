...
class Database(object):
    ...
    def npy_file_path(self, file_name):
    ...
    def save(self, time, img, data, name=None, age=None):
        ...
        self.npy_save(time=time, data=data, name=name)
    ...
    def npy_save(self, time, data, name=None):
        # name==None
        if name==None:
            file_name = os.path.join(self.FILE_PATH, time)
        else:
            file_name = os.path.join(self.FILE_PATH, str(name))
            # file_name = str(self.FILE_PATH) + "/" + str(name)
    ...
    def npy_load(self, name):
        ...
        if os.path.isfile(file_name):  # name -> absolute path
            ...
            file_name = os.path.join(self.FILE_PATH, file_name)  # name == 'dfdf.npy'
